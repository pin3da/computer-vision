...
% The paper headers
\markboth{Computer vision class, Universidad Tecnologica de Pereira ~ 2017-I}%
...
in the computer vision class. There are three experiments to test, the first
two expertiments remove perspective from images and the last one adds
perspective to one image.
...
%
%
% The authors would like to thank... ASasdfsD
%
